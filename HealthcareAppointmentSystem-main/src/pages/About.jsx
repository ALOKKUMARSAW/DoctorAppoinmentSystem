        ...
        <div className="team-grid">
          <div className="team-card">
            ...
            <div className="social-links">
              <a href="https://www.linkedin.com/in/alok-kumar-saw/" target="_blank" rel="noopener noreferrer">
                <FaLinkedin size={20} /> 
              </a>
              <a href="https://www.instagram.com/aloksaw512/?hl=en" target="_blank" rel="noopener noreferrer">
                <FaInstagram size={20} /> 
              </a>
            </div>
          </div>
          <div className="team-card">
            <h3>Roshan Raj Mahato</h3>
            <p>Frontend Developer</p>
          </div>
          <div className="team-card">
            <h3>Alok Kumar Saw</h3>
